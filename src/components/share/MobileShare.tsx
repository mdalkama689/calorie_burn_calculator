...
const MobileShare = () => {
  ...
  const whatsappMessage = encodeURIComponent(
   "I found this useful calorie burn  calculator tool, check it out: https://seosaurus.in/tools/calorie-burn-calculator/"
  );

  const toolUrl = "https://seosaurus.in/tools/calorie-burn-calculator/";
